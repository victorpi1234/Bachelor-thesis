function [ct, cst] = working_PTV_shaped_cone_mod(ct, cst, modulatorDepth, yLocation, coneBaseRadius, coneLengthFactor, coneSpacingX, coneSpacingZ, HU, cutout_start, width_margingsYXZ, structureColor, varargin)
