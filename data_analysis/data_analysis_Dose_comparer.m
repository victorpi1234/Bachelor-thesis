function [] = data_analysis_Dose_comparer(ct_mod,cst_mod,ct_no_mod, cst_no_mod, resultGUI,resultGUI_no_mod, pln, modulator_type, rows, slice)
if nargin < 9 || isempty(rows)
    rows = 1;
end
if nargin < 10 || isempty(slice)
