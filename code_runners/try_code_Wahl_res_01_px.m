...
ct_no_mod = makeCT(1100,450,450, 0.1);
[ct_no_mod, cst_no_mod] = makeCST_water(ct_no_mod, 200, 20, [-330 0 0], [],[],[],-10);

%% Cone Modulator
clearvars ct cst % ct_no_mod cst_no_mod
[ct,cst] = new_PTV_shaped_coned_inverse_good(ct_no_mod,cst_no_mod,15, 200,5,300,11, 11,600,[],[1 1 1]); % Cone modulator; HU= 132 for PMMA
...
%% Data analysis 
title_text = "Cone Modula tor pixel size 0.1, tooth lenght 300px, tooth width 5px";
slice = matRad_world2cubeIndex(pln.propStf.isoCenter(1,:),ct);
data_analysis_one_Dose(ct, cst, resultGUI, pln, title_text, slice(3), "on", [0 60]);
...
%% Save png
folderpng = 'C:\Users\victo\bachelor_thesis\dkfz\DKFZ_BachelorThesis\Thesis\Pictures\19_05\';
% saveas(gcf, [folderpng,'Cone_modulator_Difference_Cones_Lenght_80_width_3_HU_600_Z_axis_plus_3.png'])
saveas(gcf, [folderpng,'Cone_modulator_Res_01_Cones_Lenght_300px_width_5px_HU_600_axis_centre.png'])
