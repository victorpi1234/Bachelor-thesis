function [ct, cst] = makeCST_modified(ct, RadiusPTV, RadiusOAR, PTV_center, HU_tissue, HU_PTV, HU_OAR) % Warning! Use a square CT!
...
%% Creation of OAR (positioned relative to PTV)
% OAR_center = [PTV_center(1)-RadiusPTV-RadiusOAR-20.0, PTV_center(2), PTV_center(3)];
